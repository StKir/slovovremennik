  ...
  return (
    <section className={styles.addSection}>
      <div className="container">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={styles.add_word_form} name="mainForm">
          <div className={styles.form_left}>
            <label className={styles.form_label} htmlFor="word">
              ...
              <Controller
                ...
                defaultValue=""
                render={({ field }) => <MainInput placeholder="Введие слово" {...field} />}
              />
            ...
            <label className={styles.form_label} htmlFor="description">
              ...
              <Controller
                ...
                render={({ field }) => <MainTextArea placeholder="Введие слово" {...field} />}
              />
