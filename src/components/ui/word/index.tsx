...
const ShowWordWithInformation: React.FC<{ content: IWord; disableFunct: () => void }> = ({
  content,
  disableFunct,
}) => {
  return (
...
const Words: React.FC<{ content: IWord }> = ({ content }) => {
  ...
  return <ShowWordWithInformation content={content} disableFunct={funcChangeShowInfo} />;
};
